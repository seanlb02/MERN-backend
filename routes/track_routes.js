...
import { authoriseTracker, getTrackers, getTracking, revokeAccess, validateTracker } from '../controllers/track_ controllers.js';
...
// route used to validate a tracker before accessing another user's summary page

router.get('/validate/:tracked', authenticateToken, validateTracker)
